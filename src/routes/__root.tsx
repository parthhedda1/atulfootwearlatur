...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Trusted footwear shop in Latur. Visit Atul Footwear at Lahoti Landmark, Sawe Wadi for quality shoes, expert guidance, and convenient parking." },
      ...
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/b5150b43-3e4b-4ee2-927d-85c3103ef3fd" },
    ],
    links: [
      {
        rel: "preconnect",
